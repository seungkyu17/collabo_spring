...
//Specification : 'JPA'의 'Creteria API' 를 사용하여 'where' 절(검색 조건)을 객체 지향적으로 만들기 위하여 사용되는 인터페이스 입니다.
//즉, 'JPA'를 사용하여 동적 쿼리를 만들어주는 인터페이스입니다.
public class ProductSpecification {
    /* 사용자가 지정한 날짜 범위의 상품 목록만 필터링해주는 'Specification' 입니다.
       searchDateType : 검색할 날짜 범위를 의미하는 문자열
       반환값 : 검색된 범위의 상품 목록을 조회하기 위한 'Specification' 객체 정보 */
    ...
    /* 사용자가 지정한 특정 카테고리에 속하는 상품 목록만 필터링해주는 'Specification' 입니다.
       category : 검색할 카테고리 문자열
       반환값 : 해당 카테고리에 해당하는 상품 목록을 조회하기 위한 'Specification' 객체 정보 */
    ...
    public static Specification<Product> hasCategory(Category category){
        return new Specification<Product>() {
            ...
            public Predicate toPredicate(Root<Product> root, CriteriaQuery<?> query, CriteriaBuilder criteriaBuilder) {
                ...
                //'conjunction() 메소드' 는 논리적으로 항상 'true' 인 객체를 반환해 줍니다.
                //'sql'의 'where 구문' 을 만들지 않습니다.
    ...
    /* 상품 이름에 특정 키워드가 포함된 상품 목록만 필터링해주는 'Specification' 입니다.
       keyword : 상품 이름에 포함될 키워드
       반환값 : 상품 이름의 키워드가 포함된 상품 목록을 조회하기 위한 'Specification' 객체 정보 */
    ...
    /* 상품 상세 설명에 특정 키워드가 포함된 상품 목록만 필터링해주는 'Specification' 입니다.
       keyword : 상품 상세 설명에 포함될 키워드
       반환값 : 상품 상세 설명에 키워드가 포함된 상품 목록을 조회하기 위한 'Specification' 객체 정보 */
